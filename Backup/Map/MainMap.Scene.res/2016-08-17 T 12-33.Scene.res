<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="1648119971">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="550549137">
        <_items dataType="Array" type="Duality.GameObject[]" id="2859673070" length="4">
          <item dataType="Struct" type="Duality.GameObject" id="1248863235">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1978407171">
              <_items dataType="Array" type="Duality.Component[]" id="3765446950" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="3609178167">
                  ...
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <parentTransform dataType="Struct" type="Duality.Components.Transform" id="4008434903">
                    <active dataType="Bool">true</active>
                    <angle dataType="Float">0</angle>
                    <angleAbs dataType="Float">0</angleAbs>
                    <angleVel dataType="Float">0</angleVel>
                ...
                <item dataType="Struct" type="Duality.Components.Camera" id="1786139042">
                  ...
                  <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="857138294">
                    <_items dataType="Array" type="Duality.Components.Camera+Pass[]" id="1370247136" length="4">
                      <item dataType="Struct" type="Duality.Components.Camera+Pass" id="2555403228">
                      ...
                      <item dataType="Struct" type="Duality.Components.Camera+Pass" id="3959925014">
                        <clearColor dataType="Struct" type="Duality.Drawing.ColorRgba" />
                        <clearDepth dataType="Float">1</clearDepth>
                ...
                <item dataType="Struct" type="CampGame.CameraControl.RigidCameraController" id="2428507948">
                  <active dataType="Bool">true</active>
                  <gameobj dataType="ObjectRef">1248863235</gameobj>
                  <targetObj dataType="ObjectRef">1648119971</targetObj>
                </item>
              </_items>
              <_size dataType="Int">3</_size>
              <_version dataType="Int">5</_version>
            </compList>
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2554621880" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="454943849">
                  <item dataType="ObjectRef">2939589526</item>
                  <item dataType="Type" id="664568078" value="Duality.Components.Camera" />
                  <item dataType="Type" id="349821258" value="CampGame.CameraControl.RigidCameraController" />
                </keys>
                <values dataType="Array" type="System.Object[]" id="522892992">
                  <item dataType="ObjectRef">3609178167</item>
                  <item dataType="ObjectRef">1786139042</item>
                  <item dataType="ObjectRef">2428507948</item>
                </values>
              </body>
            </compMap>
            ...
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="1483836107">F2TZCqnEHECDyISznrDyCA==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <name dataType="String">Camera</name>
            <parent dataType="ObjectRef">1648119971</parent>
            <prefabLink />
          </item>
        </_items>
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="728253088">
        <_items dataType="Array" type="Duality.Component[]" id="2919049531" length="4">
          ...
          <item dataType="Struct" type="CampGame.CameraControl.CursorFollower" id="3349101508">
            <_x003C_BaseSpeed_x003E_k__BackingField dataType="Float">1</_x003C_BaseSpeed_x003E_k__BackingField>
            <_x003C_Cursor_x003E_k__BackingField dataType="Struct" type="Duality.GameObject" id="2311568667">
              <active dataType="Bool">true</active>
              <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1345132245">
                <_items dataType="Array" type="Duality.GameObject[]" id="1823251958" length="4" />
                <_size dataType="Int">0</_size>
                <_version dataType="Int">2</_version>
              </children>
              <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3520829000">
                <_items dataType="Array" type="Duality.Component[]" id="545593343" length="4">
              ...
              <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1927425759" surrogate="true">
                <header />
                <body>
                  <keys dataType="Array" type="System.Object[]" id="1107531012">
                    <item dataType="ObjectRef">2939589526</item>
                    <item dataType="ObjectRef">2405582554</item>
                    <item dataType="Type" id="482723140" value="CampGame.CursorComponent" />
                  </keys>
                  <values dataType="Array" type="System.Object[]" id="976219542">
              ...
              <identifier dataType="Struct" type="System.Guid" surrogate="true">
                <header>
                  <data dataType="Array" type="System.Byte[]" id="208195520">ZP8PXMg5dEKuNOw3VUmCCw==</data>
                </header>
                <body />
              </identifier>
              <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
              ...
              <parent />
              <prefabLink />
            </_x003C_Cursor_x003E_k__BackingField>
            <_x003C_CursorDistanceThreshold_x003E_k__BackingField dataType="Float">200</_x003C_CursorDistanceThreshold_x003E_k__BackingField>
            ...
            <_x003C_SpeedScale_x003E_k__BackingField dataType="Float">0.1</_x003C_SpeedScale_x003E_k__BackingField>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3918843651" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Object[]" id="218802212">
            ...
            <item dataType="Type" id="322425750" value="CampGame.CameraControl.CursorFollower" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="1692649750">
            <item dataType="ObjectRef">4008434903</item>
            <item dataType="ObjectRef">500094853</item>
            <item dataType="ObjectRef">3349101508</item>
          </values>
        </body>
      </compMap>
    ...
    <item dataType="ObjectRef">2311568667</item>
